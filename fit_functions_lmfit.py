...
class N1DGaussian:
    ...
    def fit_n_1d_gaussians(self):
        ...
        return best_fit_param, fit_param_std_err
...
class FitBoxes:
    __slots__ = "giwaxs_img_container", "plot_fits"

    def __init__(self, giwaxs_img_container, plot_fits):

        self.giwaxs_img_container = giwaxs_img_container
    ...
    def fit(self):
        ...
        for c_b, b_in_c in zip(enumerate(peak_cluster_boxes), peak_boxes_inside_clusters):
            ...
            best_fit_param, fit_param_err, errors = N2DGaussian(raw_giwaxs_img, b_in_c, c_b[1], plot_result=False).fit_n_2d_gaussian()
